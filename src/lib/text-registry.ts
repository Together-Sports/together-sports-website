...
export const TEXT_FIELDS: TextField[] = [
  // Home
  { key: "home.heroCtaTeam", label: "Hero Team Button", page: "Home", fallback: "Meet Our Team" },
  ...
  { key: "partners.why1Body", label: "Why Card 1 Text", page: "Partners", fallback: "Your organization connects with the 2,000+ youth and families we reach across NYC, Texas, California, Florida, Ohio, India, and Thailand.", multiline: true },
  { key: "partners.why2Title", label: "Why Card 2 Title", page: "Partners", fallback: "Shared Values" },
  { key: "partners.why2Body", label: "Why Card 2 Text", page: "Partners", fallback: "Align with a mission built on inclusion: every kid plays, regardless of background, income, or ability.", multiline: true },
  { key: "partners.why3Title", label: "Why Card 3 Title", page: "Partners", fallback: "Digital Feature" },
  { key: "partners.why3Body", label: "Why Card 3 Text", page: "Partners", fallback: "Co-branded visibility across our website, social channels, and press coverage.", multiline: true },
  ...
  { key: "partners.perk1", label: "Perk 1", page: "Partners", fallback: "Co-branded visibility across our website, social channels, and press coverage" },
  { key: "partners.perk2", label: "Perk 2", page: "Partners", fallback: "Direct access to programming across 7 regions and 3 countries" },
  { key: "partners.perk3", label: "Perk 3", page: "Partners", fallback: "Volunteer and staff engagement opportunities through hands-on coaching" },
  { key: "partners.perk4", label: "Perk 4", page: "Partners", fallback: "A seat at the table on new program design and expansion" },
